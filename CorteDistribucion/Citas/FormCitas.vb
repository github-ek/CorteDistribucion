...
#Region "Metodos Load/Unload Formulario"
    Private Sub FormAsignacionCitas_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Loading = True
...
#Region "Seccion Filtros"
    ...
    Private Sub cbxCiudadOrigen_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxCiudadOrigen.SelectedIndexChanged
        ...
        Me.Limpiar()
    End Sub
    Private Sub chkPermitirOrdenesConCita_CheckedChanged(sender As Object, e As EventArgs) Handles chkPermitirOrdenesConCita.CheckedChanged
        Me.Consultar()
    End Sub
...
#Region "Metodos Consultar"
    ...
    Private Shared Function GetCondiciones() As String
        Return "(condicion_estado_orden And condicion_estado_distribucion And condicion_requiere_servicio_distribucion And condicion_requiere_confirmacion_cita)"
    End Function
    ...
    Private Function GetSQLConsultaPrincipal() As String
        ...
        Dim NoPermitirOrdenesConCita As Boolean = Not chkPermitirOrdenesConCita.Checked
        Dim FiltrarSoloIncluirIncluidas As Boolean = chkSoloIncluidas.Checked

        Dim sql = My.Settings.AsignacionCitasSQLConsulta _
    ...
    Private Function CheckParametrosConsultar(Optional alertar As Boolean = False) As Boolean
        Dim FechaDesde As Date = dtpFechaDesde.Value
        Dim FechaHasta As Date = dtpFechaHasta.Value
        Dim PermitirOrdenesConCita As Boolean = chkPermitirOrdenesConCita.Checked
